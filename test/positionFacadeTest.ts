...
const DIST_TO_SEARCH = 500; // meter
...
describe("## Verify the Positions Facade ##", () => {
  ...
  before(async function () {
    ...
    // laver index én gang kommer uden om problem med samme index flere gange (in memory bliver kun sat op én gang, glemmer til næste gang)
  })
